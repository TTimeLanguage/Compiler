...
public class Token {
	...
	public static final Token dateTok = new Token(TokenType.Date, "date");
	...
	public static final Token elseIfTok = new Token(TokenType.ElseIf, "else if");
	...
	public static final Token plusAssignTok = new Token(TokenType.PlusAssign, "+=");
	...
	public static final Token minusAssignTok = new Token(TokenType.MinusAssign, "-=");
	public static final Token minusMinusTok = new Token(TokenType.MinusMinus, "--");
	public static final Token multiplyTok = new Token(TokenType.Multiply, "*");
	public static final Token multiplyAsssignTok = new Token(TokenType.MultiplyAssign, "*=");
	public static final Token divideTok = new Token(TokenType.Divide, "/");
	public static final Token divideAssignTok = new Token(TokenType.DivideAssign, "/=");
	...
	public static Token mkTimeLiteral(String name) {
		return new Token(TokenType.TimeLiteral, name);
	}

	public static Token mkDateLiteral(String name) {
		return new Token(TokenType.DateLiteral, name);
	}
